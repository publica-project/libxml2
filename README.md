...
[![GoDoc](https://godoc.org/github.com/publica-project/libxml2?status.svg)](https://godoc.org/github.com/publica-project/libxml2)


## Why?

I needed to write [go-xmlsec](https://github.com/publica-project/xmlsec). This means we need to build trees using libxml2, and then muck with it in xmlsec: Two separate packages in Go means we cannot (safely) pass around `C.xmlFooPtr` objects (also, you pay a penalty for pointer types). This package carefully avoid references to `C.xmlFooPtr` types and uses uintptr to pass data around, so other libraries that needs to interact with libxml2 can safely interact with it.
...
import (
  ...
  "github.com/publica-project/libxml2"
  "github.com/publica-project/libxml2/parser"
  "github.com/publica-project/libxml2/types"
  "github.com/publica-project/libxml2/xpath"
)
...
import (
  ...
  "github.com/publica-project/libxml2"
  "github.com/publica-project/libxml2/xsd"
)
...
ok      github.com/publica-project/libxml2  37.597s
```

## See Also

* https://github.com/publica-project/xmlsec
